...
const MainPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-emerald-50 dark:from-gray-900 dark:via-gray-900 dark:to-teal-900 relative overflow-hidden font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
            {/* Background Blobs */}
            ...
            <nav className="relative z-50 flex items-center justify-between px-6 py-6 md:px-12 max-w-7xl mx-auto">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-teal-600 tracking-tight">
                        Rizqa<span className="text-gray-700 dark:text-gray-300">AI</span>
                    </span>
                </div>
                <div>
                    <Link
            ...
            <header className="relative z-10 px-6 pt-10 pb-20 md:pt-20 md:pb-32 max-w-7xl mx-auto text-center">
                <motion.div
                    ...
                    variants={fadeIn}
                >
                    <span className="inline-block px-4 py-1.5 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 font-bold text-xs uppercase tracking-widest mb-6 border border-green-200 dark:border-green-800/50">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link
                            to="/login"
                            className="px-8 py-4 rounded-2xl bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-bold text-lg shadow-lg hover:shadow-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all border border-gray-100 dark:border-gray-700"
                        >
                            Access Dashboard
                        </Link>
                    </div>
            ...
            <section className="relative z-10 px-6 py-20 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm border-t border-white/50 dark:border-gray-800">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <motion.div
                            ...
                            className="p-8 rounded-3xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none hover:shadow-2xl hover:-translate-y-1 transition-all"
                        >
                        ...
                        <motion.div
                            ...
                            className="p-8 rounded-3xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none hover:shadow-2xl hover:-translate-y-1 transition-all"
                        >
                            <div className="w-16 h-16 rounded-2xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-purple-600 dark:text-purple-400 mb-6 text-2xl">
                                <FaRobot />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2. AI Analysis</h3>
                            <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                        ...
                        <motion.div
                            ...
                            className="p-8 rounded-3xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none hover:shadow-2xl hover:-translate-y-1 transition-all"
                        >
                            <div className="w-16 h-16 rounded-2xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400 mb-6 text-2xl">
                                <FaPaperPlane />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. Automated Success</h3>
                            <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            <footer className="relative z-10 py-12 px-6 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
                    <div className="flex items-center gap-2 mb-6 opacity-50 grayscale hover:grayscale-0 transition-all">
                        ...
                        <span className="text-xl font-bold text-gray-700 dark:text-gray-300">RizqaAI</span>
                    </div>
